...
1.
https://www.hotelmycamp.com sayfasina gidelim
2.
Cucumber parametre ,cucumber scenario outline ve TestNg framework
...
And
DCB Bank'in listede oldugunu test eder
...
Given user web sayfasinda
And
“Istenen Sirket” Prev.Close degerini yazdirir
...
2.
Cucumber framework’de US1012_Guru_Web_Tables altinda
Scenario : TC_18_kullanici_satir_sutun_degeri_ile_yazi_alabilmeli olusturun ve
asagidaki testi yapin
Given user web sayfasinda
And
“Istenen Satir”, “Istenen Sutun” daki yaziyi yazdirir
...
Given user web sayfasinda
And
“Istenen Baslik”, sutunundaki tum degerleri yazdirir
...
https://the
internet.herokuapp.com/add_remove_elements/ adresine gidin
1)
